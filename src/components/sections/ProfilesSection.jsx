  ...
  return (
    <section id="profiles" className="relative py-28 px-6 md:px-12 lg:px-16 overflow-hidden bg-surface/50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {profiles.platforms.map(platform => (
            ...
            >
              ...
              <h3 className="font-pixel-display text-lg font-semibold text-foreground group-hover:text-accent transition-colors">
                {platform.name}
              </h3>
        ...
        <h3 className="font-pixel-display text-2xl font-semibold text-foreground mb-6">{achievements.title}</h3>
        <div className="flex flex-col gap-4">
          {achievements.items.map((item, index) => {
            ...
            return (
              ...
              >
                <div>
                  <h4 className="font-pixel-display text-lg font-semibold text-foreground group-hover:text-accent transition-colors">
                    {item.title}
                  </h4>
